...
public class Vacancy implements Serializable {
	...
	public Vacancy(int idVacancy, String vacancyNumber, Date TimestampCreated, User user, String state, Position position,
			String description, int numberOpening, Department department, Date TimestampClose, String requirement,
	...
	public void setDateCreated(Date TimestampCreated) {
	...
	public void setDateClose(Date Timestamp) {
	...
	public String toString() {
		return "Vacancy [idVacancy=" + idVacancy + ", vacancyNumber=" + vacancyNumber + ", TimestampCreated=" + dateCreated
				...
				+ gender + ", degree=" + degree + ", typeOfStaff=" + typeOfStaff +  "]";
	}
